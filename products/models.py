...
class Product(models.Model):
    ...
    min_rental_period = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(1)])
    ...
    features = models.JSONField(null=True, default=list, blank=True)
    specifications = models.JSONField(default=dict, blank=True)

    # Product Details
    weight = models.DecimalField(max_digits=8, decimal_places=2, null=True, blank=True)
    warranty_months = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(0)])
    ...
    # ⭐ FIXED: Use CloudinaryField instead of ImageField
    main_image = CloudinaryField(
        'image',
        blank=True,
        null=True,
        help_text="Main product image (uploads to Cloudinary)"
    )
...
class ProductImage(models.Model):
    ...
    image = CloudinaryField(
        'image',
        help_text="Product image (uploads to Cloudinary)"
    )
